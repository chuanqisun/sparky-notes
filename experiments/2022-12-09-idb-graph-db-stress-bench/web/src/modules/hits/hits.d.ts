import type { EdgeSchema, NodeSchema, NodeSchemaV2 } from "../graph/db";
...
export interface HitsReportNode extends NodeSchemaV2 {
  type: "report";
  title: string;
  entityType: number;
  group?: {
...
export interface HitsClaimNode extends NodeSchemaV2 {
  type: "claim";
  title: string;
  entityType: number;
}

export interface HitsIncludesEdge extends EdgeSchema {
  type: "includes";
}
export interface HitsTranscludesEdge extends EdgeSchema {
  type: "transcludes";
}
